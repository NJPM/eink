...
TITLE_HEIGHT = round(HEIGHT / 2) + 20
DETAILS_HEIGHT = HEIGHT - TITLE_HEIGHT
TEXT_WIDTH = WIDTH - IMAGE_WIDTH - 1

TITLE_TEXT_SIZE = 1.85
DETAILS_TEXT_SIZE = 0.7

LEFT_PADDING = 5

TITLE = "hroar"
DETAIL = "Play with me ->"
IMAGE = "images/vibeqr.jpg"
...
def draw_badge():
    ...
    display.rectangle(1, TITLE_HEIGHT + 1, TEXT_WIDTH, DETAILS_HEIGHT - 2)
