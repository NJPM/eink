...
TITLE = "hroar"
NAME_1 = "NO HEAVY \nPETTING"
NAME_2 = "HEAVY PETTING ENCOURAGED"
IMAGE_1 = "images/heavy1.jpg"
IMAGE_2 = "images/heavy2.jpg"
...
badger_os.state_load("heavy", state)
...
def draw_badge():
    ...
    display.set_font("sans")
    multiline_text(state['text'], LEFT_PADDING, TITLE_HEIGHT*2, 0.8, WIDTH)
...
while True:
    ...
    if changed:
        draw_badge()
        badger_os.state_save("heavy", state)
        changed = False
