...
TITLE = "HROAR"
NAME = "is listening \n to hypno"
DETAIL = 'SEND A DM STARTING "Hey mutt" TO @hroar'
...
def draw_badge():
    ...
    display.text(title, LEFT_PADDING + (title_text_width // 2), (TITLE_HEIGHT // 2), WIDTH, TITLE_TEXT_SIZE)
    ...
    display.set_pen(15)
    display.line(WIDTH - IMAGE_WIDTH, (HEIGHT - QR_HEIGHT) - 1, (WIDTH - IMAGE_WIDTH) + QR_HEIGHT, (HEIGHT - QR_HEIGHT) - 1)
    display.line((WIDTH - IMAGE_WIDTH) + QR_HEIGHT, (HEIGHT - QR_HEIGHT) - 1, (WIDTH - IMAGE_WIDTH) + QR_HEIGHT, HEIGHT)
    # display.line(WIDTH - IMAGE_WIDTH, HEIGHT - 1, WIDTH - 1, HEIGHT - 1)
    # display.line(WIDTH - 1, 0, WIDTH - 1, HEIGHT - 1)
    # Draw qr image
    jpeg.open_file(QR)
    jpeg.decode(WIDTH - IMAGE_WIDTH, HEIGHT - QR_HEIGHT)
