...
def draw_badge():
    ...
    # Uncomment this if a white background is wanted behind the TITLE
    # display.set_pen(15)
    # display.rectangle(1, 1, TEXT_WIDTH, TITLE_HEIGHT - 1)
    ...
    #name_length = display.measure_text(detail, DETAILS_TEXT_SIZE)
